                ...
                <div class="col-12 col-sm-4 text-center text-sm-start">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="categorySubMenu">
                            ...
                            <a class="dropdown-item" href="web-productdos.php">Menú 2</a>
        ...
        <div class="container-cards full-box">
            ...
            <div class="card-product div-bordered bg-white shadow-2">
                <figure class="card-product-img">
                    <img class="img-fluid" src="<?php echo SERVERURL; ?>vistas/assets/img/ihpone.jpg" alt="nombre_producto">
                </figure>
                <div class="card-product-body">
                    <div class="card-product-content scroll">
                        <h5 class="text-center fw-bolder">Celular IPHONE12</h5>
            ...
            <div class="card-product div-bordered bg-white shadow-2">
                <figure class="card-product-img">
                    <img class="img-fluid" src="<?php echo SERVERURL; ?>vistas/assets/img/lap1.jpg" alt="nombre_producto">
                </figure>
                <div class="card-product-body">
                    <div class="card-product-content scroll">
                        <h5 class="text-center fw-bolder">LAPTOP LENOVO IDEAPAD 1 INTEL CELERON 128GB SSD 4GB</h5>
                        <p class="card-product-price text-center fw-bolder">$800.00 USD</p>
                        <span class="full-box text-center text-muted" style="display: block;">En stock</span>
                    </div>
                    <div class="text-center card-product-options" style="padding: 10px 0;">
                        <button type="button" class="btn btn-link btn-sm btn-rounded text-success" ><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Agregar</button>
            ...
            <div class="card-product div-bordered bg-white shadow-2">
                <figure class="card-product-img">
                    <img class="img-fluid" src="<?php echo SERVERURL; ?>vistas/assets/img/lap2.jpg" alt="nombre_producto">
                </figure>
                <div class="card-product-body">
                    <div class="card-product-content scroll">
                        <h5 class="text-center fw-bolder">LAPTOP ASUS VIVOBOOK 15 15.6" X512DA AMD RYZEN 5 256GB SSD 8GB</h5>
                        <p class="card-product-price text-center fw-bolder">$1800.00 USD</p>
                        <span class="full-box text-center text-muted" style="display: block;">En stock</span>
                    </div>
                    <div class="text-center card-product-options" style="padding: 10px 0;">
                        <button type="button" class="btn btn-link btn-sm btn-rounded text-success" ><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Agregar</button>
            ...
            <div class="card-product div-bordered bg-white shadow-2">
                <figure class="card-product-img">
                    <img class="img-fluid" src="<?php echo SERVERURL; ?>vistas/assets/img/table1.jpg" alt="nombre_producto">
                </figure>
                <div class="card-product-body">
                    <div class="card-product-content scroll">
                        <h5 class="text-center fw-bolder">GALAXY TAB S6 LITE 4G 10" 64GB 4GB 8MP</h5>
                        <p class="card-product-price text-center fw-bolder">$450.00 USD</p>
                        <span class="full-box text-center text-muted" style="display: block;">En stock</span>
                    </div>
                    <div class="text-center card-product-options" style="padding: 10px 0;">
                        <button type="button" class="btn btn-link btn-sm btn-rounded text-success" ><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Agregar</button>
            ...
            <div class="card-product div-bordered bg-white shadow-2">
                <figure class="card-product-img">
                    <img class="img-fluid" src="<?php echo SERVERURL; ?>vistas/assets/img/table2.jpg" alt="nombre_producto">
                </figure>
                <div class="card-product-body">
                    <div class="card-product-content scroll">
                        <h5 class="text-center fw-bolder">SAMSUNG GALAXY TAB A WIFI 8" 32GB 2GB 8MP 2MP</h5>
                        <p class="card-product-price text-center fw-bolder">$1990.00 USD</p>
                        <span class="full-box text-center text-muted" style="display: block;">En stock</span>
                    </div>
                    <div class="text-center card-product-options" style="padding: 10px 0;">
                        <button type="button" class="btn btn-link btn-sm btn-rounded text-success" ><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Agregar</button>
            ...
            <div class="card-product div-bordered bg-white shadow-2">
                <figure class="card-product-img">
                    <img class="img-fluid" src="<?php echo SERVERURL; ?>vistas/assets/img/moni1.jpg" alt="nombre_producto">
                </figure>
                <div class="card-product-body">
                    <div class="card-product-content scroll">
                        <h5 class="text-center fw-bolder">MONITOR LED LG 23.5" FHD 75HZ</h5>
                        <p class="card-product-price text-center fw-bolder">$350.00 USD</p>
                        <span class="full-box text-center text-muted" style="display: block;">En stock</span>
                    </div>
                    <div class="text-center card-product-options" style="padding: 10px 0;">
                        <button type="button" class="btn btn-link btn-sm btn-rounded text-success" ><i class="fas fa-shopping-bag fa-fw"></i> &nbsp; Agregar</button>
